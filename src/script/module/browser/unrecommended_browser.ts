...
import { getEngineMajorVersion } from './internal/ua/get_engine_major_version';
import { getEngineName } from './internal/ua/get_engine_name';
import { IS_SAFARI } from './is_safari';

const browserName = getBrowserName();
const SUPPORTED_BLINK = getEngineName() === 'blink' && getEngineMajorVersion() >= 62;
