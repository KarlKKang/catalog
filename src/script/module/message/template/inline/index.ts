...
export const incompletedEmailChange = 'メールアドレスの変更は現在進行中です。終了までしばらくお待ちください。';
...
export const accountDeactivated = 'お客様のアカウントは無効化されています。アカウントの再有効化をご希望の場合は、管理者（<a class="link" href="mailto:admin@featherine.com">admin@featherine.com</a>）にご連絡ください。';