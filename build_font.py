...
for font_family in font_families:
    for font in font_family['fonts']:
        font_splitter (font['font_name'], font_family['dir'], font['file_name'], font['file_extension'], font['font_weight'], font_family['font_family'], font_family['is_cjk'], font_family['split_blocks'], dir_surfix)

font_splitter ("Segoe MDL2 Assets", "Segoe", "SegMDL2", "ttf", None, 'SegMDL2', False, {}, dir_surfix, 'block', {"custom": "U+E70D,U+E971,U+E972"})